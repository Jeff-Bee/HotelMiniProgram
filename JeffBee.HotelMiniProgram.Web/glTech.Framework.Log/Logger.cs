...
namespace JeffBee.HotelMiniProgram.Log
{
    /// <summary>
    ...
    public static class Logger
    {
       ...
       // public static List<string> _listSpecifiedLoggerName = new List<string>();
        ...
        {
            Log(logNames, LoggingLevel.Info, message, null);
        }
        ...
        {
            Log(logNames, LoggingLevel.Debug, message, null);
        }
        ...
        {
            Log(logNames, LoggingLevel.Warning, message, null);
        }
        ...
        {
            Log(logNames, LoggingLevel.Error, message, null);
        }
        ...
        {
            Log(logNames, LoggingLevel.Fatal, message, null);
        }
        ...
        public static void Log(string[] logNames, LoggingLevel loggingLevel, string message, object loggingProperties)
        {
